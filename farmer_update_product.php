...
if(isset($_POST['update_product'])){
   ...
   $update_product->execute([$name, $category, $quantity, $details, $price, $pid]);
...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" name="quantity" min="0" placeholder="enter product quantity" required class="box" value="<?= $fetch_products['quantity']; ?>">
      ...
      <div class="flex-btn">
         ...
         <a href="farmer_product.php" class="option-btn">go back</a>
      </div>
   </form>
   <?php
         }
